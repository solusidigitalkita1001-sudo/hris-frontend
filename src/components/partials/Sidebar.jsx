                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a className="sidebar-link" href="./main/app-email.html">
                      <iconify-icon icon="solar:letter-line-duotone" />
                      Email
                    </a>
                  </li>
                  <li className="sidebar-item">
                  ...
                  <li className="sidebar-item">
                    <a className="sidebar-link" href="./main/app-chat.html">
                      <iconify-icon icon="solar:chat-round-line-line-duotone" />
                      Chat
                    </a>
                  </li>
                  <li className="sidebar-item">
                  ...
                  <li className="sidebar-item">
                    <a className="sidebar-link" href="./main/app-contact2.html">
                      <iconify-icon icon="solar:phone-line-duotone" />
                      Contact List
                    </a>
                  </li>
                  <li className="sidebar-item">
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:accessibility-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:card-search-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      href="./main/pages-block-ui.html"
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:quit-full-screen-square-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:sort-by-time-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    ...
                    >
                      <iconify-icon icon="solar:align-vertical-spacing-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      className="sidebar-link"
                      href="./main/widgets-feeds.html"
                    >
                      <iconify-icon icon="solar:feed-line-duotone" />
                      <span className="hide-menu">Feeds</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a className="sidebar-link" href="./main/widgets-apps.html">
                      <iconify-icon icon="solar:clapperboard-text-line-duotone" />
                      <span className="hide-menu">Apps</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a className="sidebar-link" href="./main/widgets-data.html">
                      <iconify-icon icon="solar:database-line-duotone" />
                  ...
                  <ul className="sidebar-menu" id="sidebarnav">
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        aria-expanded="false"
                      >
                        <iconify-icon icon="solar:text-selection-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        aria-expanded="false"
                      >
                        <iconify-icon icon="solar:password-minimalistic-input-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:repeat-one-minimalistic-bold-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        href="./main/form-dropzone.html"
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:flip-horizontal-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        href="./main/form-typeahead.html"
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:high-quality-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:waterdrop-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:square-transfer-horizontal-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:calendar-date-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:smartphone-update-line-duotone" />
                    ...
                    <li className="sidebar-item">
                      <a
                        ...
                        className="sidebar-link"
                      >
                        <iconify-icon icon="solar:clapperboard-edit-line-duotone" />
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:align-horizonta-spacing-line-duotone" />
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:chart-2-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:pie-chart-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:round-graph-line-duotone" />
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a href="./main/ui-badge.html" className="sidebar-link">
                      <iconify-icon icon="solar:tag-horizontal-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a href="./main/ui-modals.html" className="sidebar-link">
                      <iconify-icon icon="solar:bolt-line-duotone" />
                      <span className="hide-menu">Modals</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a href="./main/ui-tab.html" className="sidebar-link">
                      <iconify-icon icon="solar:box-minimalistic-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:flag-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:programming-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:text-bold-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:balloon-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:slider-minimalistic-horizontal-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a href="./main/ui-scrollspy.html" className="sidebar-link">
                      <iconify-icon icon="solar:multiple-forward-right-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a href="./main/ui-link.html" className="sidebar-link">
                      <iconify-icon icon="solar:link-round-angle-bold-duotone" />
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:star-fall-minimalistic-2-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:watch-square-minimalistic-charge-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:stars-minimalistic-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:station-minimalistic-bold-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:cloud-snowfall-minimalistic-line-duotone" />
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:bug-minimalistic-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:password-outline" />
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      className="sidebar-link"
                    >
                      <iconify-icon icon="solar:siderbar-line-duotone" />
                ...
                <ul className="sidebar-menu" id="sidebarnav">
                  ...
                  <li className="sidebar-item">
                    <a
                      ...
                      aria-expanded="false"
                    >
                      <iconify-icon icon="solar:align-left-line-duotone" />
                  ...
                  <li className="sidebar-item">
                    <div className="sidebar-link">
                      <span className="round-10 rounded-circle d-block bg-primary" />
                      <span className="hide-menu">Applications</span>
                    </div>
                  </li>
                  <li className="sidebar-item">
                    <div className="sidebar-link">
                      <span className="round-10 rounded-circle d-block bg-secondary" />
                      <span className="hide-menu">Form Options</span>
                    </div>
                  </li>
                  <li className="sidebar-item">
                    <div className="sidebar-link">
                      <span className="round-10 rounded-circle d-block bg-danger" />
                      <span className="hide-menu">Table Variations</span>
                    </div>
                  </li>
                  <li className="sidebar-item">
                    <div className="sidebar-link">
                      <span className="round-10 rounded-circle d-block bg-warning" />
                      <span className="hide-menu">Charts Selection</span>
                    </div>
                  </li>
                  <li className="sidebar-item">
                    <div className="sidebar-link">
                      <span className="round-10 rounded-circle d-block bg-success" />
                      <span className="hide-menu">Widgets</span>
                    </div>
                  </li>
                </ul>
